// Advanced SEO Configuration for Top Rankings
...
// Advanced Meta Tags for High Rankings
export const advancedMetaTags = {
  ...
  social: [
    { property: "og:site_name", content: "Candela Public School" },
    { property: "og:locale", content: "en_IN" },
    { property: "og:type", content: "website" },
    { property: "article:publisher", content: "https://www.facebook.com/candelapublicschool" },
    { name: "twitter:site", content: "@CandelaSchool" },
    { name: "twitter:creator", content: "@CandelaSchool" }
  ]
};
